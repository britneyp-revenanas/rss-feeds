...
.PHONY: feeds_clay_changelog
feeds_clay_changelog: ## Generate RSS feed for Clay Changelog
	$(call check_venv)
	$(call print_info,Generating Clay Changelog feed)
	$(Q)python feed_generators/clay_changelog.py
	$(call print_success,Clay Changelog feed generated)
